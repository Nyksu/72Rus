  ...
  <tr> 
    <td bgcolor="#CCCCCC" bordercolor="#333333"> 
      <p><font face="Arial, Helvetica, sans-serif"><a href="index.asp"> На главную 
        страницу</a> | <a href="pubarea.asp">Кабинет редактора</a> | <a href="bloknews.asp">Блоки 
        новостей</a> | <%=backadr==""?"":"Вернуться к "+backadr%></font></p>
    </td>
  </tr>
</table>
<%if(ErrorMsg!=""){%>
...
<form name="form1" method="post" action="ednewsheading.asp">
  ...
  <table width="780" border="1" bordercolor="#FFFFFF" align="center">
    ...
    <tr> 
      <td width="300" bordercolor="#333333" valign="middle" height="18"> 
        <div align="right"> 
          <p><font size="2">URL шаблона:</font><font size="2">&nbsp;&nbsp;</font></p>
        </div>
      </td>
      ...
      <td bordercolor="#333333" valign="top" height="18"> 
        <p><font size="2"> 
          <input type="text" name="url" value="<%=isFirst?url:Request.Form("url")%>" maxlength="50">
          </font></p>
      </td>
    </tr>
    <tr> 
