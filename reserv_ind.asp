...
<html>
<head>
<title>72RUS.RU Тюменский Регион - Тюмень, информационный портал. Объявления, Каталог сайтов, Новости, Расписание транспорта</title>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr> 
    <td background="images/fon02.gif" height="87" align="center" width="170"> 
      <img src="images/72rus.gif" width="170" height="87" alt="72RUS.RU Тюменский Регион - информационный портал "> 
    </td>
  ...
  <tr> 
    <td colspan="3" height="19"> 
      <p class="menu02"><img src="images/e06.gif" width="16" height="9" alt="" border="0"> 
        ...
        доменов RU COM NET</a> <img src="images/e06.gif" width="16" height="9" alt="" border="0"> 
        <a href="http://www.rusintel.ru/">Разработка интернет сайтов</a> <img src="images/e06.gif" width="16" height="9" alt="" border="0"> 
  ...
  <tr> 
    <td background="images/fon02.gif" height="87" align="center" width="170"> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td align="center"> 
            <p class="menu01"><a href="http://www.rusintel.ru/goodslst.asp?divis=4&hid=2244" target="_blank"><img src="HeadImg/rol20.gif" width="120" height="72" align="middle" border="0" alt="Интернет карты РОЛ в Тюмени"></a> 
            </p>
          </td>
        </tr>
      </table>
...
delete recs
%>
  <!--LiveInternet logo--><a href="http://www.liveinternet.ru/click" target=liveinternet><img src="http://counter.yadro.ru/logo?16.1" border=0 width=88 height=31 alt="liveinternet.ru: показано число хитов за 24 часа, посетителей за 24 часа и за сегодня"></a><!--/LiveInternet-->
