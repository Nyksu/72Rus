...
<table border="0" cellspacing="0" cellpadding="0" align="center" height="900">
  <tr valign="top"> 
    <td height="369"> 
      ...
      <table width="97%" border="0" cellspacing="0" cellpadding="0" align="center" height="30">
        <tr> 
          <td valign="middle"> 
...
while (!Records.EOF)
{
	...
	Records.MoveNext()
%>
            <p class="menu02"><a  href="<%=url%>"><%=hname%></a></p>
            <%
} 
Records.Close()
delete recs
%>
      ...
      <table border="0" align="center" cellspacing="0" width="97%">
        <tr> 
          <td bgcolor="#FFFFFF" width="100%" height="65"> 
            <table border="1" cellspacing="2" cellpadding="0" align="left" bordercolor="#FFFFFF" width="200">
              <tr> 
                <td bgcolor="#EBEEF5" bordercolor="#333333"> 
                  <%if (imgLname != "") {%>
                  <img class= "digest" src="<%=imgLname%>" border="1" alt="<%=pname%>" > 
                  <%}else{%>
                  <%}%>
                </td>
              </tr>
              <tr> 
                <td bordercolor="#333333"> 
                  <p class="digest"><font color="#333333" size="1"><%=pdat%>&nbsp; 
                    <%=autor%>&nbsp; <%=sos%></font></p>
                  <p><a href="printme.asp?pid=<%=pid%>" target="_blank"><font size="1">Версия 
                    для печати</font></a><br>
                    <A href="#" onclick="window.external.AddFavorite(parent.location,document.title)"><font size="1">Сделать 
                    закладку</font></A></p>
                  <p><font size="1"><a href="http://tyumen.fastbb.ru/?1-0">Обсудить</a></font></p>
                </td>
              </tr>
            </table>
