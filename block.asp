  ...
  <tr> 
    <td bgcolor="#CCCCCC" bordercolor="#333333"> 
      <p><font face="Arial, Helvetica, sans-serif"><a href="index.asp"> На главную страницу</a> 
        | <a href="pubarea.asp">Кабинет редактора</a> | <a href="bloknews.asp">Блоки 
        новостей</a> </font></p>
    </td>
  </tr>
</table>
<h1 align="center">СМИ: <%=sminame%></h1>
<h1 align="center">Блок новостей № <%=bk%> : <font color="#0000CC"><%=name%></font></h1>
...
<p>&nbsp;</p><table width="780" border="1" cellspacing="0" cellpadding="0" align="center" bordercolor="#FFFFFF">
  <tr>
    <td bordercolor="#333333" bgcolor="#99CCFF"> 
...
<table width="780" border="1" bordercolor="#FFFFFF" align="center">
  <tr bordercolor="#333333" bgcolor="#FFFFCC"> 
    <td colspan="2"> 
      <p><b><font color="#FFFF00"> <font color="#0000FF">Позиция:</font><font color="#FFFFFF"> 
        <font color="#FF0000"><%=pos%></font> ||</font></font></b> <a href="delbkpub.asp?pid=<%=pid%>&bk=<%=bk%>&tp=1">УДАЛИТЬ 
        из БЛОКА</a> || <a href="delbkpub.asp?pid=<%=pid%>&bk=<%=bk%>">ПЕРЕМЕСТИТЬ 
  ...
  <tr bordercolor="#CCCCCC"> 
    <td> 
      <p>Дата создания: <font color="#009900"><b><%=cdat%></b></font> || Автор:<b> <%=autor%></b></p>
    </td>
    <td>
