...
<div align="center"> 
  <h1><font color="#3366FF">Кабинет редактора </font></h1>
</div>
<table width="100%" border="0">
  <tr> 
    <td bgcolor="#FFFFFF"> 
      <div align="center"> 
        <p align="left"><font color="#0000CC"><b>Здравствуйте, <%=name_mem%> !</b></font></p>
      </div>
    </td>
  </tr>
</table>
<table width="100%" border="1" bordercolor="#FFFFFF">
  ...
  <tr bordercolor="#333333" valign="top"> 
    <td width="50%" height="50"> 
      <ul>
        <li> 
          <p><a href="index.asp">Редактировать издание</a></p>
        </li>
        <%if (tpm==0) {%>
        <li> 
          <p><a href="addpubusr.asp">Добавить пользователя</a></p>
        </li>
        <%}%>
      </ul>
    </td>
    <td width="50%" height="50"> 
      <ul>
        <li> 
          <p><a href="bloknews.asp">Блоки новостей</a></p>
        </li>
        <%if (tpm==0) {%>
        <li> 
          <p><a href="pubusrlst.asp">Список пользователей</a></p>
        </li>
        <%}%>
        <%if (tpm<4) {%>
        <li> 
          <p><a href="headimglst.asp">Имиджи для рубрик и разделов</a></p>
        </li>
        <%}%>
      </ul>
    </td>
...
<h1 align="center"><b>Публикации в очереди:</b></h1>
<%
...
<table width="100%" border="1" bordercolor="#FFFFFF" align="center">
  <tr bordercolor="#333333" bgcolor="#CCCCCC"> 
    <td colspan="2"> 
      <p><b><font color="#FFFF00"> <font color="#FFFFFF">|| <a href="pubresume.asp?pid=<%=pid%>&st=1">Опубликовать</a> 
        || <a href="delpub.asp?pid=<%=pid%>">Удалить</a> 
        || <a href="removepub.asp?pid=<%=pid%>&hid=<%=hid%>">ПЕРЕМЕСТИТЬ</a> 
        || <a href="edpub.asp?pid=<%=pid%>">ИЗМЕНИТЬ</a> 
        || <a href="bloknews.asp?pid=<%=pid%>">Разместить 
        в блок</a></font></font></b></p>
    </td>
  </tr>
  ...
  <tr bordercolor="#CCCCCC"> 
    <td> 
      <p><font color="#000000">Дата создания: <b><%=cdat%></b> || Дата выхода<b> : <%=pdat%> || </b>Разместил:<b> <%=creater%></b> <b>|| </b>Автор:<b> <%=autor%></b></font></p>
    </td>
    <td> 
      <div align="center"> 
        <p><b>Фото Миниатюра</b></p>
      </div>
    </td>
  </tr>
  <tr valign="top"> 
    <td bordercolor="#CCCCCC" width="81%"> 
      <p><font size="2" >Дайджест: <%=digest%></font> <a href="<%=url%>?pid=<%=pid%>">Просмотр 
        текста</a></p>
      <p> | <a href="addpubimg.asp?pid=<%=pid%>">Добавить 
        иллюстрацию (фотографию)</a> | </p>
      <p><font color="#FF0000">Блоки:&nbsp;<font size="1" color="#0000FF"> 
        <%
    ...
    <td bordercolor="#CCCCCC" width="20%"> 
      <div align="center"> 
        <p> 
          <%if (imgname != "") {%>
          <img src="<%=imgname%>" > 
