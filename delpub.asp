...
<p align="center">Удаление публикации необратимо и ее невозможно будет востановить!</p>
<p align="center">Если Вы решили удалить публикацию, то поставьте флажок в соответствующем 
...
<form name="form1" method="post" action="delpub.asp">
  ...
  <p align="center"> 
    ...
    Да, я хочу удалить эту публикацию: (<b><font color="#FF0000" size="3"><%=name%></font></b>) !</p>
  <p align="center">&nbsp;</p>
  <p align="center"> 
