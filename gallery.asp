...
while (!Records.EOF)
{
	...
	Records.MoveNext()
%>
                    <img src="images/arrow_next.gif" width="14" height="13" align="absmiddle">&nbsp;&nbsp; <a  href="<%=url%>"><%=hname%></a> <br>
                    <%
} 
Records.Close()
delete recs
      ...
      <table border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td width="166" valign="top" align="center"> 
            <table width="156" border="0" cellspacing="0" cellpadding="0" height="135" bordercolor="#000000">
              <tr> 
                <td align="center" valign="middle" bgcolor="#000000" height="14"><img src="HeadImg/film_top.gif" width="156" height="14"></td>
              </tr>
              <tr> 
                <td align="center" valign="middle" bgcolor="#000000"> 
                  <%if (imgname != "") {%>
                  <a href="<%=url%>"><img src="<%=imgname%>" alt="<%=pname%>" border="0" align="absmiddle"></a> 
                  <%}else{%>
                  &nbsp; 
                  <%}%>
                </td>
              ...
              <tr> 
                <td align="center" valign="middle" bgcolor="#000000" height="14"><img src="HeadImg/film_bott.gif" width="156" height="15"></td>
              </tr>
            </table>
            <p><a href="<%=url%>"><%=pname%></a> 
              <%if (usok) {%>
              <br>
              <a href="pubresume.asp?pid=<%=pid%>&st=0"><font color="#006600" size="1">Остановить</font></a><font size="1"> 
              | <a href="delpub.asp?pid=<%=pid%>"><font color="#006600">Удалить</font></a><br>
              <a href="bloknews.asp?pid=<%=pid%>"><font color="#006600">В блок</font></a> 
              | <a href="edpub.asp?pid=<%=pid%>"><font color="#006600">Редактировать</font></a></font> 
              <%}%>
            </p>
          </td>
          <% if (endtable) {%>
        ...
        <tr bgcolor="#CCCCCC" bordercolor="#CC3333"> 
          <td bgcolor="#FFFFFF" align="CENTER" bordercolor="#FFFFFF" height="23"> 
            ...
            <table width="97%" border="1" cellspacing="2" cellpadding="0" bordercolor="#F4F7FF" align="center">
              <tr bordercolor="#EBF3F5"> 
                <%if (pg>0) {%><td bordercolor="#EBF3F5" bgcolor="#F7F7F7" width="33%" align="left"> 
                  <p> <img src="images/arrow_back.gif" width="14" height="13" align="absmiddle"> 
                    <a href="gallery.asp?hid=<%=hid%>&pg=<%=pg-1%>">Предыдущая страница</a></p>
                </td>
                <%
  } 
if (pos>=lpag*(1+pg)) {%><td width="33%" bgcolor="#F7F7F7" align="center"> 
                  <p><b><font color="#999999"><a href="gallery.asp?hid=<%=hid%>"><%=nm%></a></font></b></p>
                </td>
                <td bordercolor="#EBF3F5" bgcolor="#F7F7F7" align="right"> 

                  <p> <a href="gallery.asp?hid=<%=hid%>&pg=<%=pg+1%>">Следующая 
                    страница</a> <img src="images/arrow_next.gif" width="14" height="13" align="absmiddle"> 
                  </p>
                </td>
                <%}%>
              </tr>
            ...
            <p align="center">&nbsp;</p>
            <hr size="1" width="75%">
            <p align="center"><font color="#666666" size="1">При использовании 
              информационных материалов 72RUS.RU на интернет сайтах, включая тексты, 
              фотографии, изображения, обязательно указание гиперссылки вида: 
              <a href="http://www.72rus.ru">www.72rus.ru</a> Для авторских материалов, 
              также обязательно указывать автора.</font></p>
