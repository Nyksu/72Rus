            ...
            <table width="100%" border="1" bordercolor="#EBF3F5" cellspacing="2">
              <tr valign="top" bgcolor="#FFFFFF" bordercolor="#C5DCE2">
                <td height="23" bordercolor="#C5DCE2" width="90%"> 
                  <p class="digest"><font size="2"><a href="<%=urladr%>" target="_blank"><img src="http://open.thumbshots.org/image.pxf?url=<%=urladr%>" border="0" onLoad="if (this.width>50) this.border=1" alt="<%=urladr%>" align="left"></a><%=urlabout%></font></p>
                </td>
