  ...
  <tr> 
    <td bordercolor="#CCCCCC"> 
      <p><a href="pubarea.asp"><b>Кабинет редактора</b></a> | <a href="index.asp">Редактировать 
        издание</a> | <a href="bloknews.asp">Блоки новостей</a> </p>
    </td>
  </tr>
</table>
<%if(ErrorMsg!=""){%>
...
<%}%>
<%if(ShowForm){%>
<h1 align="center"><b><font size="3">Здесь можно изменить параметры блока новостей. 
...
<form name="form1" method="post" action="edblock.asp">
  <p align="center"> 
    ...
    Для добавления информационного блока, пожалуйста, заполните поля формы: </p>
  <table width="780" border="1" bordercolor="#FFFFFF" align="center">
    ...
    <tr bordercolor="#333333"> 
      <td width="380" valign="middle" height="18"> 
        <div align="right"><font size="2" color="#FF0000">Краткое описание, назначение:</font><font size="2">&nbsp;&nbsp;</font></div>
      </td>
      <td width="10" height="18" bordercolor="#FFFFFF"> 
        <div align="center">-</div>
      </td>
      <td width="582" valign="top" height="18"> 
        <p><font size="2"> 
          <input type="text" name="name" value="<%=isFirst?name:Request.Form("name")%>" maxlength="100" size="50">
          до 100 символов</font></p>
      </td>
    </tr>
  </table>
...
{%>
<center>
  <h1><font color="#3333FF">Блок изменен!</font></h1>
</center>
<%}%>
<p>&nbsp;</p>
</body>
