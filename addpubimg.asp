	...
	if (Request.ServerVariables("REQUEST_METHOD")=="POST") {
	   updown = Server.CreateObject("ANUPLOAD.OBJ")
		...
		try {
			...
			if (size>40960){throw "Не более 20kB."}
...
<html>
<head>
<title>Загрузка фотографии к публикации: <%=pname%></title>
...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
  <tr bgcolor="#FFCC00"> 
    <td colspan="3" height="17" bgcolor="#CCCCCC" bordercolor="#CCCCCC"> 
      <p align="left"><%=path%> Публикация: <a href="newshow.asp?pid=<%=pid%>"> 
        <%=pname%></a></p>
    </td>
  </tr>
</table>
...
<form name="form1" method="post" action="addpubimg.asp" enctype="multipart/form-data">
  ...
  <div align="center"> 
    <p>графические файлы GIF или JPG до 40 килобайт</p>
  </div>
  <div align="center"> 
    ...
    <td> 
      <ul>
        <li><font face="Arial, Helvetica, sans-serif" size="2"><b>Миниатюра для 
          ...
          блоках публикаций. Рекомендуемый размер: ширина 150 пикселов. <B>Если 
          больше, то не размещать этот материал в блоки!</B></font></li>
        <li><font face="Arial, Helvetica, sans-serif" size="2"><b>Основная фотография 
          слева от текста</b> - выводится на странице публикации в левой колонке. 
          Рекомендуемый размер: ширина max до 300 пикселов!</font> <BR>
        </li>
        <li><font face="Arial, Helvetica, sans-serif" size="2"><b>Дополнительная 
          фотография снизу от основной</b> - выводится в левой колонке от публикации. 
          Может служить для загрузки дополнительной графической информации (графики, 
          схемы и т.п.). Максимальная ширина до 300 пикс. Высота не критична.</font></li>
      </ul>
    </td>
  </tr>
</table>
